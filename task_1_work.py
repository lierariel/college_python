...
def load_rules(path: str): # function that will open file read it and remove white spaces.
    ...
    split_by_letters = spaces_removed.split('<>')
    file.close()
...
if __name__ == '__main__':
    ...
    print(load_rules("C:\\Users\\Victoria_Rouch\\OneDrive - Milton Keynes College O365\\course\\programming\\Task 2\\example_1.txt"))
